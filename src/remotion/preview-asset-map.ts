...
export const previewAssetMap: PreviewAssetMap = {
  ...
  "Your Song [Official Video] - Rita Ora - RsELrcVNzG0": {
    audioSrc: new URL("../../artifacts/songs/Your Song [Official Video] - Rita Ora - RsELrcVNzG0/audio.mp3", import.meta.url).href,
    backgroundSrc: new URL("../../artifacts/songs/Your Song [Official Video] - Rita Ora - RsELrcVNzG0/background.png", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/Your Song [Official Video] - Rita Ora - RsELrcVNzG0/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/Your Song [Official Video] - Rita Ora - RsELrcVNzG0/audio-features.json", import.meta.url).href)
  },
  "First Time High [Official Audio] - Rita Ora - qW9Z5BghHus": {
    audioSrc: new URL("../../artifacts/songs/First Time High [Official Audio] - Rita Ora - qW9Z5BghHus/audio.mp3", import.meta.url).href,
    loadRenderInput: async () => ({}),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/First Time High [Official Audio] - Rita Ora - qW9Z5BghHus/audio-features.json", import.meta.url).href)
  },
  "Girls ft. Cardi B- Bebe Rexha & Charli XCX [Official Video] - Rita Ora - ExJmET8boVw": {
    audioSrc: new URL("../../artifacts/songs/Girls ft. Cardi B- Bebe Rexha & Charli XCX [Official Video] - Rita Ora - ExJmET8boVw/audio.mp3", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/Girls ft. Cardi B- Bebe Rexha & Charli XCX [Official Video] - Rita Ora - ExJmET8boVw/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/Girls ft. Cardi B- Bebe Rexha & Charli XCX [Official Video] - Rita Ora - ExJmET8boVw/audio-features.json", import.meta.url).href)
  },
  "Put Your Records On - Corinne Bailey Rae - cDrU3weV3_Y": {
    audioSrc: new URL("../../artifacts/songs/Put Your Records On - Corinne Bailey Rae - cDrU3weV3_Y/audio.mp3", import.meta.url).href,
    backgroundSrc: new URL("../../artifacts/songs/Put Your Records On - Corinne Bailey Rae - cDrU3weV3_Y/background.png", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/Put Your Records On - Corinne Bailey Rae - cDrU3weV3_Y/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/Put Your Records On - Corinne Bailey Rae - cDrU3weV3_Y/audio-features.json", import.meta.url).href)
  },
  "about time - Sarah Kang Music - LssgRVr8djY": {
    audioSrc: new URL("../../artifacts/songs/about time - Sarah Kang Music - LssgRVr8djY/audio.mp3", import.meta.url).href,
    backgroundSrc: new URL("../../artifacts/songs/about time - Sarah Kang Music - LssgRVr8djY/background.png", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/about time - Sarah Kang Music - LssgRVr8djY/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/about time - Sarah Kang Music - LssgRVr8djY/audio-features.json", import.meta.url).href)
  },
  "Sarah Kang - Summer Is for Falling in Love (live acoustic) - Sarah Kang Music - vWQ7E0wZ5BU": {
    audioSrc: new URL("../../artifacts/songs/Sarah Kang - Summer Is for Falling in Love (live acoustic) - Sarah Kang Music - vWQ7E0wZ5BU/audio.mp3", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/Sarah Kang - Summer Is for Falling in Love (live acoustic) - Sarah Kang Music - vWQ7E0wZ5BU/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/Sarah Kang - Summer Is for Falling in Love (live acoustic) - Sarah Kang Music - vWQ7E0wZ5BU/audio-features.json", import.meta.url).href)
  },
  "Lucky - Jason Mraz - ezVbN7e-L7Y": {
    audioSrc: new URL("../../artifacts/songs/Lucky - Jason Mraz - ezVbN7e-L7Y/audio.mp3", import.meta.url).href,
    backgroundSrc: new URL("../../artifacts/songs/Lucky - Jason Mraz - ezVbN7e-L7Y/background.png", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/Lucky - Jason Mraz - ezVbN7e-L7Y/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/Lucky - Jason Mraz - ezVbN7e-L7Y/audio-features.json", import.meta.url).href)
  },
  "I Know a Place - chevy - K6QK_dVk8BY": {
    audioSrc: new URL("../../artifacts/songs/I Know a Place - chevy - K6QK_dVk8BY/audio.mp3", import.meta.url).href,
    backgroundSrc: new URL("../../artifacts/songs/I Know a Place - chevy - K6QK_dVk8BY/background.png", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/I Know a Place - chevy - K6QK_dVk8BY/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/I Know a Place - chevy - K6QK_dVk8BY/audio-features.json", import.meta.url).href)
  },
  "let's run away - Sarah Kang Music - rqpra7nXL_g": {
    audioSrc: new URL("../../artifacts/songs/let's run away - Sarah Kang Music - rqpra7nXL_g/audio.mp3", import.meta.url).href,
    backgroundSrc: new URL("../../artifacts/songs/let's run away - Sarah Kang Music - rqpra7nXL_g/background.png", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/let's run away - Sarah Kang Music - rqpra7nXL_g/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/let's run away - Sarah Kang Music - rqpra7nXL_g/audio-features.json", import.meta.url).href)
  },
  "Fly Me to the Moon - Lucky (Mash-Up) (feat. Breea Guttery) - Rick Hale Music - 1w5kYuUlqL4": {
    audioSrc: new URL("../../artifacts/songs/Fly Me to the Moon - Lucky (Mash-Up) (feat. Breea Guttery) - Rick Hale Music - 1w5kYuUlqL4/audio.mp3", import.meta.url).href,
    backgroundSrc: new URL("../../artifacts/songs/Fly Me to the Moon - Lucky (Mash-Up) (feat. Breea Guttery) - Rick Hale Music - 1w5kYuUlqL4/background.png", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/Fly Me to the Moon - Lucky (Mash-Up) (feat. Breea Guttery) - Rick Hale Music - 1w5kYuUlqL4/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/Fly Me to the Moon - Lucky (Mash-Up) (feat. Breea Guttery) - Rick Hale Music - 1w5kYuUlqL4/audio-features.json", import.meta.url).href)
  },
  "Every Second - Mina Okabe - cXf3do6ltzU": {
    audioSrc: new URL("../../artifacts/songs/Every Second - Mina Okabe - cXf3do6ltzU/audio.mp3", import.meta.url).href,
    backgroundSrc: new URL("../../artifacts/songs/Every Second - Mina Okabe - cXf3do6ltzU/background.png", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/Every Second - Mina Okabe - cXf3do6ltzU/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/Every Second - Mina Okabe - cXf3do6ltzU/audio-features.json", import.meta.url).href)
  },
  "lazy afternoon - Sarah Kang Music - RiU3HRYTM7Q": {
    audioSrc: new URL("../../artifacts/songs/lazy afternoon - Sarah Kang Music - RiU3HRYTM7Q/audio.mp3", import.meta.url).href,
    backgroundSrc: new URL("../../artifacts/songs/lazy afternoon - Sarah Kang Music - RiU3HRYTM7Q/background.png", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/lazy afternoon - Sarah Kang Music - RiU3HRYTM7Q/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/lazy afternoon - Sarah Kang Music - RiU3HRYTM7Q/audio-features.json", import.meta.url).href)
  },
  "Maybe the World is a Beautiful Place (feat. Lee Jin Ah) - Sarah Kang Music - 0bkXQYUTmgs": {
    audioSrc: new URL("../../artifacts/songs/Maybe the World is a Beautiful Place (feat. Lee Jin Ah) - Sarah Kang Music - 0bkXQYUTmgs/audio.mp3", import.meta.url).href,
    loadRenderInput: async () => ({}),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/Maybe the World is a Beautiful Place (feat. Lee Jin Ah) - Sarah Kang Music - 0bkXQYUTmgs/audio-features.json", import.meta.url).href)
  },
  "Valentine - Laufey - Ejvz4EdcXM0": {
    audioSrc: new URL("../../artifacts/songs/Valentine - Laufey - Ejvz4EdcXM0/audio.mp3", import.meta.url).href,
    backgroundSrc: new URL("../../artifacts/songs/Valentine - Laufey - Ejvz4EdcXM0/background.png", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/Valentine - Laufey - Ejvz4EdcXM0/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/Valentine - Laufey - Ejvz4EdcXM0/audio-features.json", import.meta.url).href)
  },
  "Nothing - Milena 밀레나 - _LvN1NhCeIU": {
    audioSrc: new URL("../../artifacts/songs/Nothing - Milena 밀레나 - _LvN1NhCeIU/audio.mp3", import.meta.url).href,
    backgroundSrc: new URL("../../artifacts/songs/Nothing - Milena 밀레나 - _LvN1NhCeIU/background.png", import.meta.url).href,
    loadRenderInput: () => loadJson<RawRenderInput>(new URL("../../artifacts/songs/Nothing - Milena 밀레나 - _LvN1NhCeIU/render-input.json", import.meta.url).href),
    loadAudioFeatures: () => loadJson<AudioFeatureTrack>(new URL("../../artifacts/songs/Nothing - Milena 밀레나 - _LvN1NhCeIU/audio-features.json", import.meta.url).href)
  }
};
