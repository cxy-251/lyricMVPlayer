...
- top-level render entry: `src/remotion/RenderRoot.tsx`

## Scope

- define the base composition input contract
- define the render root registration
- define one reusable lyric video composition
- connect one real `render-input.json` into Remotion rendering and the unified web preview
...
- the composition can preview and render one real song package
