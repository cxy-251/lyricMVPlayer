...
export const WebDonutLayer: React.FC<WebDonutLayerProps> = ({
  activationFrame,
  className,
  height,
  isRunning = false,
  ...
  const latestParamsRef = useRef({activationFrame, modules, seed});

  latestParamsRef.current = {activationFrame, modules, seed};
