...
export class CursorSpaceInstancedRenderer {
    ...
    sync(
        ...
        enemies: readonly CursorSpaceEnemy[],
        projectiles: readonly CursorSpaceProjectile[],
    ...
    private syncEnemies(enemies: readonly CursorSpaceEnemy[]): void {
    ...
    private syncProjectiles(projectiles: readonly CursorSpaceProjectile[]): void {
    ...
    private syncEffects(effects: readonly CursorSpaceEffect[]): void {
    ...
    private syncPlayer(player: Readonly<CursorSpacePlayer>): void {
