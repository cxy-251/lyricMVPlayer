...
export const collectiveTrajectoriesMetadata: DemoMetadata = {
  ...
  route: '/demos/collective-trajectories',
  tags: ['Canvas2D', 'Trajectories', 'Generative Art', 'Geometry'],
  instructions: ['Tune agents, trail length, and symmetry to inspect how simple motion becomes accumulated geometry.'],
};
